...
По клику на имени свойства/метода показывается блок с его параметрами и описанием (если таковые существуют). Для того, чтобы скрыть блок, кликните по этому же имени еще раз.
...
1. классы, которые не нужно отображать на странице (имена классов в нижнем регистре!)
