...
class Kohana_ORM_MPTT extends ORM {
	...
	/**
	 * Проверяет имеет ли текущий узел предков
	 * 
	 * @access  public
	 * @return  bool
	 */
	...
	/**
	 * Является ли текущий узел листовым узлом?
	 *
	 * @access  public
	 * @return  bool
	 */
	...
	/**
	 * Является ли текущий узел потомком для узла $target.
	 *
	 * @access  public
	...
	/**
	 * Проверяет, является ли текущий узел прямым потомком для $target.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  ORM_MPTT object or primary key value of target node
	 * @return  bool
	...
	/**
	 * Проверяет, является ли текущий узел прямым родителем $target.
	 * 
	 * @access  public
	...
	/**
	 * Проверяет, является ли текущий узел братом $target.
	 * (Оба имеют одного родителя)
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  ORM_MPTT object or primary key value of target node
	 * @return  bool
	...
	/**
	 * Проверяет, является ли текущий узел корневым узлом.
	 * 
	 * @access  public
	 * @return  bool
	 */
	...
	/**
	 * Проверяет, является ли текущий узел одним из родителей $target.
	 * 
	 * @access  public
	...
	/**
	 * Создает новый узел в качестве корня, или перемещает узел в корень
	 *
	 * @access  public
	...
	/**
	 * Устанавливает родителя в качестве $target. Возвращает объект нового родителя
	 * 
	 * @access  protected
	...
	/**
	 * Вставляет новый узел в качестве первого ребенка $target.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  primary key value or ORM_MPTT object of target node
	 * @return  ORM_MPTT
	...
	/**
	 * Вставляет новый узел в качестве последнего ребенка $target.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  primary key value or ORM_MPTT object of target node
	 * @return  ORM_MPTT
	...
	/**
	 * Вставляет новый узел как предыдущий элемент $target.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  primary key value or ORM_MPTT object of target node
	 * @return  ORM_MPTT
	...
	/**
	 * Вставляет новый узел как следующий элемент $target.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  primary key value or ORM_MPTT object of target node
	 * @return  ORM_MPTT
	...
	/**
	 * Возвращает корневой узел для текущего узла. Выбрасывает Kohana_Exception
	 * 
	 * @access  public
	 * @param   int             scope
	...
	/**
	 * Возвращает родителя текущего узла или NULL если он является корнем
	 * 
	 * @access  public
	 * @return  ORM_MPTT
	 */
	...
	/**
	 * Возвращает всех родителей текущего узла
	 * 
	 * @access  public
	...
	/**
	 * Возвращает всё дерево с или без указания ветви
	 * 
	 * @access  public
	...
	/**
	 * Возвращает братьев текущего узла
	 *
	 * @access  public
	 * @param   bool  include the current node
	 * @param   string  direction to order the left column by
	...
	/**
	 * Возвращает ветки текущего узла
	 * 
	 * @access  public
	 * @param   bool  include the current node
	 * @param   string  direction to order the left column by
	...
	/**
	 * Возвращает потомки текущего узла.
	 *
	 * @access  public
	 * @param   bool      include the current node
	 * @param   string    direction to order the left column by.
	...
	/**
	 * Получить число потомков текущего узла
	 * 
	 * @access  public
	 * @return  int
	 */
	...
	/**
	 * Перестраивает дерево, используя parent_column.
	 * Приказ дереву не гарантирует соответствие со структурой до реконструкции.
	 * Этот метод уменшает структуру дерева устранением дыр
	 * Если у вас есть дочерний узел, который находится за пределами влево / вправо 
	 * ограничений он не будет перемещен под корень.
	 *
	 * @access  public
