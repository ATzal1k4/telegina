			...
			<div id="loginform" class="box form">
				...
				<div class="formcont">
					<fieldset id="signin_menu">
						...
						<form method="POST" id="signin" action="/admin/login/">
							<p>
								<label for="login">Логин</label>
								<input id="login" name="login" value="<?= Arr::get($data, 'login') ?>" title="Login" class="required" tabindex="4" type="text">
							</p>
							<p>
							...
							<p class="remember">
								<input id="signin_submit" value="Войти" name="submit" tabindex="6" type="submit">
